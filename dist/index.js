...
(function(exports) {
  ...
  var FractalParameters = (function () {
      function FractalParameters(value0) {
          this.value0 = value0;
      };
      FractalParameters.create = function (value0) {
          return new FractalParameters(value0);
      };
      return FractalParameters;
  })();
  var endpoint = function (line) {
      return new Data_Tuple.Tuple(line.x + line.length * $$Math.cos(line.angle), -(-line.y + line.length * $$Math.sin(line.angle)));
  };
  var drawLine = function (ctx) {
      return function (v) {
          var v1 = endpoint(v.value0);
          return Data_Functor["void"](Control_Monad_Eff.functorEff)(Graphics_Canvas.strokePath(ctx)(function __do() {
              Data_Functor["void"](Control_Monad_Eff.functorEff)(Graphics_Canvas.moveTo(ctx)(v.value0.x)(v.value0.y))();
              Data_Functor["void"](Control_Monad_Eff.functorEff)(Graphics_Canvas.setLineWidth(v.value0.width)(ctx))();
              Data_Functor["void"](Control_Monad_Eff.functorEff)(Graphics_Canvas.lineTo(ctx)(v1.value0)(v1.value1))();
  ...
  var drawTree = function (ctx) {
      return function (v) {
          if (v instanceof Leaf) {
              return drawLine(ctx)(v.value0);
          };
          if (v instanceof Node) {
              return function __do() {
                  drawLine(ctx)(v.value0)();
                  drawTree(ctx)(v.value1)();
                  return drawTree(ctx)(v.value2)();
              };
          };
          throw new Error("Failed pattern match at Fractal line 81, column 1 - line 81, column 84: " + [ ctx.constructor.name, v.constructor.name ]);
      };
  };
  var createBranches = function (v) {
      return function (v1) {
          var v2 = endpoint(v1.value0);
          var right = new Line({
              x: v2.value0, 
              y: v2.value1, 
              angle: $$Math.pi * (v1.value0.angle / $$Math.pi - v.value0.rightAngle), 
              length: v1.value0.length * v.value0.shrinkFactor, 
              width: v1.value0.width * v.value0.shrinkFactor
          });
          var left = new Line({
              x: v2.value0, 
              y: v2.value1, 
              angle: $$Math.pi * (v1.value0.angle / $$Math.pi - v.value0.leftAngle), 
              length: v1.value0.length * v.value0.shrinkFactor, 
              width: v1.value0.width * v.value0.shrinkFactor
          });
  ...
  var createTree = function (depth) {
      return function (p) {
          return function (line) {
              ...
              var v = createBranches(p)(line);
              var right = createTree(depth - 1 | 0)(p)(v.value1);
              var left = createTree(depth - 1 | 0)(p)(v.value0);
              return new Node(line, left, right);
          };
      };
  };
  exports["FractalParameters"] = FractalParameters;
  exports["Line"] = Line;
  exports["Leaf"] = Leaf;
  exports["Node"] = Node;
...
(function(exports) {
  ...
  var Partial_Unsafe = PS["Partial.Unsafe"];
  var Prelude = PS["Prelude"];        
  var LeftAngleChanged = (function () {
      function LeftAngleChanged(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      LeftAngleChanged.create = function (value0) {
          return function (value1) {
              return new LeftAngleChanged(value0, value1);
          };
      };
      return LeftAngleChanged;
  })();
  var RightAngleChanged = (function () {
      function RightAngleChanged(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      RightAngleChanged.create = function (value0) {
          return function (value1) {
              return new RightAngleChanged(value0, value1);
          };
      };
      return RightAngleChanged;
  })();
  var renderFractal = function (params) {
      return function __do() {
          var v = Graphics_Canvas.getCanvasElementById("fractal-canvas")();
          var canvas = Data_Maybe.fromJust()(v);
          var v1 = Graphics_Canvas.getCanvasDimensions(canvas)();
          ...
          var tree = Fractal.createTree(10)(params)(trunk);
          return Fractal.drawTree(v2)(tree)();
      };
  };
  var component = (function () {
      var render = function (v) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.form_([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"]("left-angle") ])([ Halogen_HTML_Core.text("leftAngle") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.class_("slider"), Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputRange.value), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showNumber)(v.value0.leftAngle)), Halogen_HTML_Properties.min(-$$Math.pi), Halogen_HTML_Properties.max($$Math.pi), Halogen_HTML_Properties.step(new DOM_HTML_Indexed_StepValue.Step(1.0e-2)), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(function ($35) {
              return LeftAngleChanged.create(Global.readFloat($35));
          })) ]), Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"]("right-angle") ])([ Halogen_HTML_Core.text("rightAngle") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.class_("slider"), Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputRange.value), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showNumber)(v.value0.rightAngle)), Halogen_HTML_Properties.min(-$$Math.pi), Halogen_HTML_Properties.max($$Math.pi), Halogen_HTML_Properties.step(new DOM_HTML_Indexed_StepValue.Step(1.0e-2)), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(function ($36) {
              return RightAngleChanged.create(Global.readFloat($36));
          })) ]) ]), Halogen_HTML_Elements.canvas([ Halogen_HTML_Properties.id_("fractal-canvas"), Halogen_HTML_Properties.width(1024), Halogen_HTML_Properties.height(1024) ]) ]);
      };
      var initialState = new Fractal.FractalParameters({
          leftAngle: 0.0, 
          rightAngle: 0.0, 
          shrinkFactor: 0.8
      });
      var $$eval = function (v) {
          if (v instanceof LeftAngleChanged) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(Fractal.FractalParameters.create((function (v3) {
                      var $20 = {};
                      for (var $21 in v3) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v3) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(renderFractal(v3)))(function () {
          ...
          if (v instanceof RightAngleChanged) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(Fractal.FractalParameters.create((function (v3) {
                      var $28 = {};
                      for (var $29 in v3) {
          ...
          throw new Error("Failed pattern match at FractalViewer line 78, column 10 - line 90, column 16: " + [ v.constructor.name ]);
      };
  ...
  exports["LeftAngleChanged"] = LeftAngleChanged;
  exports["RightAngleChanged"] = RightAngleChanged;
  exports["component"] = component;
  exports["renderFractal"] = renderFractal;
})(PS["FractalViewer"] = PS["FractalViewer"] || {});
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
...
(function(exports) {
  ...
  var Data_Function = PS["Data.Function"];
  var Data_Unit = PS["Data.Unit"];
  var FractalViewer = PS["FractalViewer"];
  var Graphics_Canvas = PS["Graphics.Canvas"];
  var Halogen = PS["Halogen"];
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_VDom_Driver.runUI(FractalViewer.component)(Data_Unit.unit)(v))(function (v1) {
          return v1.query(Halogen_Query.action(FractalViewer.LeftAngleChanged.create(0.0)));
      });
  }));
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
