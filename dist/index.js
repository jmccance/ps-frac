...
(function(exports) {
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.form_([ Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text("leftAngle") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputRange.value), Halogen_HTML_Properties.value("0.1"), Halogen_HTML_Properties.min(-2.0 * $$Math.pi), Halogen_HTML_Properties.max(2.0 * $$Math.pi), Halogen_HTML_Properties.step(new DOM_HTML_Indexed_StepValue.Step(1.0e-2)) ]), Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text("rightAngle") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputRange.value), Halogen_HTML_Properties.value("0.1"), Halogen_HTML_Properties.min(-2.0 * $$Math.pi), Halogen_HTML_Properties.max(2.0 * $$Math.pi), Halogen_HTML_Properties.step(new DOM_HTML_Indexed_StepValue.Step(1.0e-2)) ]) ]), Halogen_HTML_Elements.canvas([ Halogen_HTML_Properties.width(800), Halogen_HTML_Properties.height(800) ]) ]);
      };
      var $$eval = function (v) {
...
(function(exports) {
  ...
  var drawTree = function (ctx) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Fractal line 81, column 1 - line 81, column 66: " + [ ctx.constructor.name, v.constructor.name ]);
      };
  };
...
(function(exports) {
  ...
  var main2 = function __do() {
      ...
      var p = new Fractal.FractalParameters({
          leftAngle: 0.1, 
          rightAngle: 0.1, 
          shrinkFactor: 0.8
      });
      var tree = Fractal.createTree(10)(p)(trunk);
      return Fractal.drawTree(v1)(tree)();
  };
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Halogen_VDom_Driver.runUI(Components.component)(Data_Unit.unit)(v);
  }));
  exports["main"] = main;
  exports["main2"] = main2;
})(PS["Main"] = PS["Main"] || {});
